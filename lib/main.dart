...
class Api{
  static const String  url = "https://darjisamajbayad.com/api/posts" ;

  Dio dio = Dio();


 Future<void> postApi(String pageNumber) async{
   var res = await dio.post(url,options: Options(
headers: {
  "Authorization":
